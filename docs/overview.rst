...
.. toctree::
   ...
   ./user/web-notifications.rst
   ./user/email-notifications.rst
   ./user/notification-preferences.rst
   ./user/silencing-notifications.rst
   ./user/notification-cache.rst
   ./user/scheduled-deletion-of-notification.rst
   ./user/settings.rst
   ./user/rest-api.rst
   ./developer/developers-docs.rst
